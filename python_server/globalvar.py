...
class global_var:
    _global_anthor = [{'enable': 1, 'short_address': 0x0001, 'x': 0, 'y': 0, 'z': 0, 'time': 0, 'qt': 0},
                      {'enable': 1, 'short_address': 0x0002, 'x': 3, 'y': 0, 'z': 0, 'time': 0, 'qt': 0},
                      {'enable': 1, 'short_address': 0x0003, 'x': 3, 'y': 1.5, 'z': 0, 'time': 0, 'qt': 0},
                      {'enable': 1, 'short_address': 0x0004, 'x': 0, 'y': 1.5, 'z': 0, 'time': 0, 'qt': 0},
